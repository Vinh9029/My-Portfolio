// e:\MyPortfolio\my-portoflio\app\login\page.tsx
"use client";
      ...
      >
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl shadow-black/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-8">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="admin@dquocvinh.ai"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold py-2.5 rounded-lg shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all active:scale-[0.98]"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-2 p-2.5 bg-slate-950 border border-slate-800 rounded-lg hover:border-cyan-500/50 hover:bg-slate-900 transition-all group">
